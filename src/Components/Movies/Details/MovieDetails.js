...
const MovieDetails = ({ route, navigation }) => {
  ...
  >
    <View style={styles.textContainer}>
      <Text style={styles.originalTitle}>{moviesDetailList.original_title}</Text>
      <Text style={styles.description}>{moviesDetailList.overview}</Text>
      ...
      <View style={styles.detailsSection}>
        ...
        <Text style={styles.language}>
          Original Language: {moviesDetailList.original_language.toUpperCase()}
        </Text>
        </View>
